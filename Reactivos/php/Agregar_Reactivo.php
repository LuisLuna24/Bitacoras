...
$Insertar="INSERT INTO public.bitacora_reactivo(
	id_bitreactivo, identificado, id_reactivo, nombre, no_lote, fecha_apertura, fecha_caducidad, pruaba_reactivo, id_usuario, id_folio)
	VALUES ($Folio, $identificar, $Reactivo, '$Reactivo', '$Lote', '$Apertura', '$Caducidad', '$ReactivoBitacora', '$id_Usuario', '$Folio');";
