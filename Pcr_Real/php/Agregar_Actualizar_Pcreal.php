...
for($i=0;$i<$Cantidad;$i++){
    ...
    if(isset($_POST['Check_Espcies'])){
        ...
        $D_Campos_especie=",'$id_especie_pcreal','$Version','1'";
    }else{
        $D_Especie="";
        $D_Campos_especie="";
    }
    ...
    $Insertar="INSERT INTO public.bitacora_pcreal(
        ...
        VALUES ('$no_registro', '$No', '$Version' ,'$identificador', '$Folio', '$Analisis', '$Fecha', '$Sanitizo', '$uv', '$Resultado', '$Obsevaciones', '$Folio', '$Version', '1', '$id_Usuario',  '1','1','$Identificador_Registro' ".$D_Campos_especie.");";
