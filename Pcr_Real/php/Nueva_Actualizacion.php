...
$BuscarPcreal="SELECT id_pcreal, no_registro, version_pcreal, identificador_bitacora, id_folio, id_analisi, fecha, sanitizo, tiempouv, resultado, observaciones, id_equipo_pcreal, version_equipo, identificador_equipo, id_usuaro, id_admin, archivo, version_folio
...
while($row=pg_fetch_assoc($queryPcr)){
    ...
    $Insertar_Nuevo="INSERT INTO public.bitacora_pcreal(
        id_pcreal, no_registro, version_pcreal, identificador_bitacora, id_folio, id_analisi, fecha, sanitizo, tiempouv, resultado, observaciones, id_equipo_pcreal, version_equipo, identificador_equipo, id_usuaro, archivo, version_folio)
        VALUES ('" . $row['id_pcreal'] . "','" . $row['no_registro'] . "' , '$VersionMax', '$Identificador', '$Folio', '" . $row['id_analisi'] . "', '" . $row['fecha'] . "', '" . $row['sanitizo'] . "', '" . $row['tiempouv'] . "', '" . $row['resultado'] . "', '" . $row['observaciones'] . "', '" . $row['id_equipo_pcreal'] . "', '" . $row['version_equipo'] . "', '" . $row['identificador_equipo'] . "', '" . $row['id_usuaro'] . "', '" . $row['archivo'] . "', '" . $row['version_folio'] . "');";
