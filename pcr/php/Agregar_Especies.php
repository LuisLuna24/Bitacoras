...
$Canmax="SELECT MAX(identificador_especie) FROM especie_pcr where id_especie_pcr='$Folio' and no_registro::text='$No_Registro'";
...
$BuscarEspecie="SELECT * FROM public.especie_pcr where id_especie='$Especie' and no_registro::text='$No_Registro';";
...
if(pg_num_rows($Espquery)==0){
    ...
    $Insertar="INSERT INTO public.especie_pcr(
        ...
        VALUES ('$Folio', '$Identificador', '1', '$Especie', '$versionespe', '$No_Registro');";
