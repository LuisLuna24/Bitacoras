...
for($i=0;$i<$Cantidad;$i++){
    $AgregaExtracion="INSERT INTO public.birtacora_extaccion(
        id_extracion, no_registro, identificador, version_extraccion, id_folio, fecha, id_metodo, id_analisis, id_area, conc_ng_ul, dato_260_280, dato_260_230,  id_equipo_extraccion, id_usuario)
        VALUES ('$id_extraccion', '$Registro', $i+1 , '1', '$Folio', '$fmuestreo', '$Metodo', '$Analisis', '$Area', '$Conc', '$D280', '$D230', $Folio, '$Usuario');";
